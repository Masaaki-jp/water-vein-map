# 自然保護・水脈マップ / Nature Conservation & Water Vein Map
...
## 1. Features
* **Water Vein Visualization:** Rivers and water bodies glow in vibrant cyan against a dark background.
* **Nature First:** Roads, transit lines, and commercial buildings are completely hidden.
* **Lightweight Architecture:** Pure HTML, CSS, and plain JavaScript. No heavy frameworks required.
* **High Legibility:** City names and labels are optimized for high contrast to maintain readability.

## 2. Tech Stack
* HTML5 / CSS3
* Vanilla JavaScript
* Google Maps JavaScript API (Legacy Styling)
